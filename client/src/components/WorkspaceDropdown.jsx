...
function WorkspaceDropdown() {
    ...
    const {openCreateOrganization} =useClerk()//this is to add functionality to create new user
        ...
        {isOpen && (
          <div className="absolute z-50 w-64 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded shadow-lg top-full left-0">
            <div className="p-2">
              ...
              {userMemberships.data.map(({ organization }) => (//we need to destructure it so that we can get image when we change the workspace
                <div
                  key={organization.id}
